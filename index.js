...
app.post('/api/login', (req, res) => {
	...
	storage.getUserByUsername(thisUser, (boo) => {
		if(boo) {
	...
	// if (storage.getUserByUsername(thisUser) === true &&
	// 	userObj.password === thisPassword) {
...
app.post('/api/newUser', (req, res) => {
	...
	var newUser = new User(newName, password);
	// console.log(newName);
	// console.log(newUser);

	storage.getUserByUsername(newName, (boo)=>{
		if(!boo){
